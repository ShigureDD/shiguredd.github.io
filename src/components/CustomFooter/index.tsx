      ...
      <footer className="text-[var(--ifm-footer-color)]">
        <div className="container container-fluid">
          <div className="row flex justify-center items-center">
            <div className="col text-center">
              <div className="flex justify-center space-x-4">
                <a href="https://linkedin.com/in/tom-l-8a8b641a5" target="_blank" rel="noreferrer" className="text-black dark:text-white hover:text-ds-blue-primary dark:hover:text-ds-blue-accent">
                ...
                <a href="https://github.com/ShigureDD" target="_blank" rel="noreferrer" className="text-[#333] dark:text-[#f5f5f5] hover:text-ds-blue-primary dark:hover:text-ds-blue-accent">
          ...
          <div className="col text-center mt-4">
              <p className="text-sm">
                &copy; {new Date().getFullYear()} ShigureDD. Built with Docusaurus.
              </p>
            </div>
        </div>
      </footer>
