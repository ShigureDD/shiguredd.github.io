    ...
    const createWidget = () => {
      ...
      const widgetConfig = {
        symbols: [
          ...
          { proName: "NASDAQ:IXIC", title: "Nasdaq index" },
          { proName: "AMEX:IWM", title: "Russell 2000 ETF" },
          { proName: "OANDA:XAUUSD", title: "Gold" },
          { proName: "TVC:VIX", title: "Volatility Index" },
          { proName: "INDEX:S5TW", title: "SPX500 20 average" },
          { proName: "INDEX:S5FI", title: "SPX500 50 average" },
          { proName: "INDEX:S5OH", title: "SPX500 100 average" },
          { proName: "INDEX:S5TH", title: "SPX500 200average" },
...
// Exporting as memo to prevent unnecessary re-renders
